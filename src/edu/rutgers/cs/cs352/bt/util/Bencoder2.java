...
public final class Bencoder2 
{
	...
	public static final byte[] encode(Object o) throws BencodingException
    {
        if(o instanceof HashMap)
            return encodeDictionary((HashMap<ByteBuffer,Object>)o);
        else if(o instanceof ArrayList)
            return encodeList((ArrayList<Object>)o);
     ...
     */
    //@SuppressWarnings("unchecked")
	private static final byte[] encodeList(ArrayList<Object> list) throws BencodingException
    {
