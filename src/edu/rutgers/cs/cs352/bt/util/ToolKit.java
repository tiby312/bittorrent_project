...
public class ToolKit
{
	...
	public static void print(Object o)
    {
        if (o instanceof ByteBuffer)
            ...
            printList((ArrayList<Object>) o, 0);
        else if (o instanceof HashMap)
            printMap((HashMap<ByteBuffer,Object>) o, 0);
        else
	...
	public static void print(Object o, int depth)
    {
        if (o instanceof ByteBuffer)
            ...
            printList((ArrayList<Object>) o, depth + 1);
        else if (o instanceof HashMap<?,?>)
            printMap((HashMap<ByteBuffer,Object>) o, depth + 1);
        else
            System.err.println("Error: Unknown type");
    }
     ...
     */
    //@SuppressWarnings("unchecked")
	public static void printList(AbstractList<Object> list, int depth)
    {
     ...
     */
    //@SuppressWarnings("unchecked")
	public static void printMap(Map<ByteBuffer,Object> map, int depth)
    {
        final Iterator<ByteBuffer> i = map.keySet().iterator();
        Object key = null;
        for (int k = 0; k < depth; k++)
            System.out.print("  ");
